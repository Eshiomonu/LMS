...
@section('header-title', 'Create a New Course')
...
<form method="POST"
    ...
    <section class="bg-white p-6 rounded shadow space-y-6">
        <div>
            ...
            <p class="text-sm text-gray-500">
                This information appears on the course card and detail page.
            </p>
        </div>
        ...
        <div>
            ...
            <textarea name="short_description"
                      rows="2"
                      class="input w-full"
                      placeholder="Short summary shown on course cards">{{ old('short_description') }}</textarea>
        ...
        <div>
            ...
            <textarea name="long_description"
                      rows="6"
                      class="input w-full"
                      placeholder="Explain what students will learn and achieve.">{{ old('long_description') }}</textarea>
    ...
    @include('admin.courses.partials.list-field', [
        ...
        'description' => 'List modules or topics covered.',
        'name' => 'curriculum'
    ])
    ...
    <section class="bg-white p-6 rounded shadow space-y-6">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="mode" class="input w-full">
                    ...
                    <option value="live_online" @selected(old('mode')==='live_online')>Live Online</option>
                    <option value="virtual" @selected(old('mode')==='virtual')>Virtual</option>
        ...
        <div>
            ...
            <textarea name="schedule" rows="2"
                      class="input w-full"
                      placeholder="e.g. Mondays & Wednesdays">{{ old('schedule') }}</textarea>
    ...
    <section class="bg-white p-6 rounded shadow flex flex-col md:flex-row gap-6">
        <label class="flex items-center gap-3">
            <input type="checkbox" name="recording" value="1" @checked(old('recording'))>
    ...
    <section class="bg-white p-6 rounded shadow space-y-6">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <div>
                ...
                <img id="cardPreview"
                     class="mt-3 hidden h-40 object-cover rounded border">
    ...
    {{-- SUBMIT --}}
    <div class="pt-4">
        <button class="bg-blue-600 text-white px-8 py-3 rounded text-lg hover:bg-blue-700">
            Create Course
        </button>
    </div>
</form>
